...
void AlgorithmsTests::WagnerFischerAlgorithmTest1(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 0);
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::WagnerFischerAlgorithmTest2(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 3);
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::WagnerFischerAlgorithmTest5(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 2);
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::WagnerFischerAlgorithmTest8(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance1, 2);
    ISHIKO_TEST_FAIL_IF_NEQ(distance2, 1);
    ISHIKO_TEST_FAIL_IF_NEQ(distance3, 2);
    ISHIKO_TEST_FAIL_IF_NEQ(distance4, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(distance5, 2);
    ISHIKO_TEST_FAIL_IF_NEQ(distance6, 3);
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest7(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 5);
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest8(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance1, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(distance2, 2);
    ISHIKO_TEST_FAIL_IF_NEQ(distance3, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(distance4, 5);
    ISHIKO_TEST_FAIL_IF_NEQ(distance5, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(distance6, 4);
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest9(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 0);
    ISHIKO_TEST_FAIL_IF_NEQ(path.size(), 0);
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest10(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(path, std::vector<Point2D<int>>({ {1,0}, {2,0}, {3,0} }));
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest11(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(path, std::vector<Point2D<int>>({ {0,1}, {0,2}, {0,3} }));
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest12(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 0);
    ISHIKO_TEST_FAIL_IF_NEQ(path, std::vector<Point2D<int>>({ {3,3} }));
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest13(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 2);
    ISHIKO_TEST_FAIL_IF_NEQ(path, std::vector<Point2D<int>>({ {3,3}, {4,3}, {5,3} }));
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest14(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 2);
    ISHIKO_TEST_FAIL_IF_NEQ(path, std::vector<Point2D<int>>({ {3,3}, {3,4}, {3,5} }));
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest15(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance, 5);
    ISHIKO_TEST_FAIL_IF_NEQ(path, std::vector<Point2D<int>>({ {1,0}, {4,4}, {5,4}, {6,6}, {6,7} }));
    ISHIKO_TEST_PASS();
}
...
void AlgorithmsTests::MyersAlgorithmTest16(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NEQ(distance1, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(path1, std::vector<Point2D<int>>({ {1,0}, {1,1}, {6,7} }));
    ISHIKO_TEST_FAIL_IF_NEQ(distance2, 2);
    ISHIKO_TEST_FAIL_IF_NEQ(path2, std::vector<Point2D<int>>({ {1,0}, {6,6} }));
    ISHIKO_TEST_FAIL_IF_NEQ(distance3, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(path3, std::vector<Point2D<int>>({ {4,4}, {5,4}, {6,4}, {6,5} }));
    ISHIKO_TEST_FAIL_IF_NEQ(distance4, 5);
    ISHIKO_TEST_FAIL_IF_NEQ(path4, std::vector<Point2D<int>>({ {1,0}, {4,4}, {5,4}, {6,6}, {6,7} }));
    ISHIKO_TEST_FAIL_IF_NEQ(distance5, 3);
    ISHIKO_TEST_FAIL_IF_NEQ(path5, std::vector<Point2D<int>>({ {1,0}, {1,1}, {6,7} }));
    ISHIKO_TEST_FAIL_IF_NEQ(distance6, 4);
    ISHIKO_TEST_FAIL_IF_NEQ(path6, std::vector<Point2D<int>>({ {1,1},  {2,1}, {4,2}, {5,2}, {8,6} }));
    ISHIKO_TEST_PASS();
}
